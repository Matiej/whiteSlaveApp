...
public class RegonNumberValidator extends ParamsSharedValidator implements ConstraintValidator<RegonNumber, String> {
    ...
    boolean checksumValidation(String param) {
        if (param.length() == SHORT_REGON_LENGTH) {
            return checkSum9(param);
        }
        return checkSum14(param);
    }
